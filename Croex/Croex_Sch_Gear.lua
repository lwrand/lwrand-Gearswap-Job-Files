...
function user_setup()
	...
	state.Weapons:options('None','Daybreak','Akademos','Khatvanga')
...
function init_gear_sets()
	...
	sets.element.Fire = {main="Daybreak"}
    ...
    sets.midcast['Elemental Magic'].Fodder = {ammo="Dosis Tathlum",
    ...
    sets.midcast['Elemental Magic'].OccultAcumen = {ammo="Seraphic Ampulla",
	...
	sets.midcast['Elemental Magic'].HighTierNuke = set_combine(sets.midcast['Elemental Magic'], {ammo="Pemphredo Tathlum",ear1="Regal Earring",ear2="Barkaro. Earring",hands="Amalric Gages +1"})
	sets.midcast['Elemental Magic'].HighTierNuke.Resistant = set_combine(sets.midcast['Elemental Magic'].Resistant, {main=gear.grioavolr_nuke_staff,ammo="Pemphredo Tathlum",ear1="Regal Earring",ear2="Barkaro. Earring",hands="Amalric Gages +1"})
