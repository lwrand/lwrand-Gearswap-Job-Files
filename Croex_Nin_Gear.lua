...
function init_gear_sets()
    ...
    sets.precast.WS = {head="Mummu Bonnet +1",
		...
		back={ name="Andartia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Evasion+10','"Dbl.Atk."+10','Phys. dmg. taken-10%',}},
	}
